...
export function StatsGrid({ accounts }: { accounts: AccountStatus[] }) {
  ...
  return (
    <div className="stat-grid">
      <article className="stat-card stat-primary"><span>Непрочитанные</span><strong>{unreadCount}</strong><small>во всех входящих</small></article>
